...
!define PRODUCT_NAME "New York Chronicles ${0.0}"
!define PRODUCT_NAME_NO_VER "New York Chronicles"

!define PRODUCT_PUBLISHER "New York Chronicles"
...
LangString	GET_XPVISTA_PLEASE	${LANG_ENGLISH} "New York Chronicles does not support Windows XP or Vista.  Please upgrade your computer."
LangString	GET_WIN81_PLEASE	${LANG_ENGLISH} "The version of New York Chronicles you've downloaded does not support Windows 7, 8 or 8.1."
LangString  GET_MASTER_PLEASE	${LANG_ENGLISH} "The version of New York Chronicles you've downloaded is designed for old versions of Windows."
...
LangString  DESC_Section1           ${LANG_ENGLISH} "The core components required to run New York Chronicles."
LangString  DESC_Section2           ${LANG_ENGLISH} "The New York Chronicles modification, allowing you to play online."
;LangString DESC_Section3           ${LANG_ENGLISH} "The map editor for New York Chronicles, allowing you to create and edit maps."
;LangString DESC_SectionGroupMods   ${LANG_ENGLISH} "Modifications for New York Chronicles. Without at least one of these, you cannot play."
LangString  DESC_SectionGroupServer  ${LANG_ENGLISH}    "The New York Chronicles Server. This allows you to host games from your computer. This requires a fast internet connection."
LangString  DESC_Section4           ${LANG_ENGLISH} "The New York Chronicles server. This is a required component."
LangString  DESC_Section5           ${LANG_ENGLISH} "The New York Chronicles modification for the server."
...
LangString  DESC_Section8           ${LANG_ENGLISH} "The Map Editor. This can be used to create your very own maps for use in gamemodes."
LangString  DESC_Section9           ${LANG_ENGLISH} "This is the SDK for creating binary modules for the server. Only install if you have a good understanding of C++!"
;LangString DESC_Blank          ${LANG_ENGLISH} ""
LangString  DESC_SectionGroupDev        ${LANG_ENGLISH} "Development code and tools that aid in the creation of mods for New York Chronicles"
LangString  DESC_SectionGroupClient  ${LANG_ENGLISH}    "The client is the program you run to play on a New York Chronicles server"
