...
public:
    ...
    virtual void SetStatusMessage(const SString& strMessage) = 0;
    virtual void ClearStatusMessage() = 0;
    virtual void SetDownloadProgress(const SString& strMessage, float fProgress) = 0;
    virtual void ClearDownloadProgress() = 0;
};
