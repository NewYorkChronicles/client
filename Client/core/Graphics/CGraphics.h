...
public:
    ...
    void SetStatusMessage(const SString& strMessage);
    void ClearStatusMessage();
    void SetDownloadProgress(const SString& strMessage, float fProgress);
...
private:
    ...
    SString                                 m_strStatusMessage;
    bool                                    m_bStatusVisible{false};
    CElapsedTime                            m_StatusExpireTimer;
    unsigned long                           m_ulStatusLifeMs{5000};
    SString                                 m_strDownloadMessage;
    float                                   m_fDownloadProgress{0.f};
    bool                                    m_bDownloadVisible{false};
