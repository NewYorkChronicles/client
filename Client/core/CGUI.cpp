...
void CLocalGUI::SetSkin(const char* szName)
{
    ...
    catch (...)
    {
        ...
        catch (...)
        {
            ...
            MessageBoxUTF8(0, _("The skin you selected could not be loaded, and the default skin also could not be loaded, please reinstall New York Chronicles."),
...
void CLocalGUI::CreateWindows(bool bGameIsAlreadyLoaded)
{
    ...
    SString   strText = SString("New York Chronicles | Build %s", __DATE__);
