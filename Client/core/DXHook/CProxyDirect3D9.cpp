...
// Change the window title to New York Chronicles
#ifdef MTA_DEBUG
    SetWindowTextW(hFocusWindow, MbUTF8ToUTF16("New York Chronicles [DEBUG]").c_str());
#else
    SetWindowTextW(hFocusWindow, MbUTF8ToUTF16("New York Chronicles").c_str());
#endif
                                 ...
                                 D3DPRESENT_PARAMETERS* pPresentationParameters, IDirect3DDevice9** ppReturnedDeviceInterface)
{
    ...
    if (hResult != D3D_OK)
    {
        // Handle fatal error
        SString strMessage;
        strMessage += "There was a problem starting New York Chronicles\n\n";
