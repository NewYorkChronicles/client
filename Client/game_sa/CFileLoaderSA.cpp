...
// Use the dynamically-resolved pointer (initialized in CGameSA constructor after FLA patches).
// Falls back to reading the instruction operand directly if accessed before CGameSA init.
static CBaseModelInfoSAInterface** GetModelInfoPtrs() { return CModelInfoSAInterface::ms_modelInfoPtrs ? CModelInfoSAInterface::ms_modelInfoPtrs : (CBaseModelInfoSAInterface**)GetARRAY_ModelInfo(); }
#define CModelInfo_ms_modelInfoPtrs GetModelInfoPtrs()
