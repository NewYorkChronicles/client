...
// Read dynamically — FLA may patch the instruction operand at 0x5B8B08+6 to point to a relocated array.
inline void* GetCStreaming_ms_aInfoForModel() { return *(void**)(0x5B8B08 + 6); }
inline void* GetARRAY_ModelLoaded() { return (char*)GetCStreaming_ms_aInfoForModel() + 0x10; }
// Keep backward-compatible names as macros for existing code
#define CStreaming__ms_aInfoForModel  GetCStreaming_ms_aInfoForModel()
#define ARRAY_ModelLoaded             GetARRAY_ModelLoaded()
...
// Read dynamically — FLA patches the instruction operand at 0x403DA4+3 to point to the relocated model info array.
inline void* GetARRAY_ModelInfo() { return *(void**)(0x403DA4 + 3); }
#define ARRAY_ModelInfo GetARRAY_ModelInfo()
